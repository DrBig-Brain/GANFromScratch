...
class Generator(nn.Module):
    def __init__(self, z_dim, channels_img, features_g, num_classes, img_size, embed_size):
        ...
        self.gen = nn.Sequential(
            ...
            self._block(z_dim + embed_size, features_g*16,4,1,0),#Nxf_g*16x4x4
...
writer_real = SummaryWriter(f"runs/ConditionalGAN/real")
writer_fake = SummaryWriter(f"runs/ConditionalGAN/fake")
